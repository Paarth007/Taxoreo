...
@section('content')
    ...
    <section class="section about-section-two">
        <div class="container" style="text-align:justify">
            <p align="center">
                This Privacy Policy governs the manner in which Taxoreo.com collects, uses,
                maintains and discloses information collected from users (each, a "User")
                of the http://www.taxoreo.com website ("Site"). This privacy policy applies
                to the Site and all products and services offered by taxoreo.
            </p>
            <p>
            ...
            <p style="text-align:justify">
                ...
                on the site, place an order, and in connection with other activities,
                services, features or resources we make available on our Site. Users may be
            ...
            <p style="text-align:justify">
                ...
                sometimes to track information about them. User may choose to set their web
                browser to refuse cookies, or to alert you when cookies are being sent. If
            ...
            <p style="text-align:justify">
                Taxoreo may collect and use Users personal information for the following
                purposes:
            </p>
            <ol type="a">
                <li>
                ...
                <li>
                    <p style="text-align:justify">
                        ...
                        detailed unsubscribe instructions at the bottom of each email or
            ...
            <p style="text-align:justify">
                Sensitive and private data exchange between the Site and its Users happens
                over a SSL secured communication channel and is encrypted and protected
                with digital signatures. Our Site is also in compliance with PCI
            ...
            <p style="text-align:justify">
                ...
                sites on the Internet. DART uses "non personally identifiable information"
                and does NOT track personal information about you, such as your name, email
                address, physical address, etc. You may opt out of the use of the DART
            ...
            <p style="text-align:justify">
                Taxoreo.com have the discretion to update this privacy policy at any time.
                When we do, we will send you an email. We encourage Users to frequently
                check this page for any changes to stay informed about how we are helping
                to protect the personal information we collect. You acknowledge and agree
            ...
            <p style="text-align:justify">
                ...
                site, or your dealings with this site, please contact us at: TAXOREO
                <br/>
                Advanced Institute of Accounts And Taxation Private Limited
                <br/>
                15, Bhande Plot Umred Road Nagpur-440009 Maharashtra India
                <br/>
                Phone : + 91 9404088555.
            </p>
            <p>
