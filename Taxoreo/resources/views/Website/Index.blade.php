                        ...
                        <div class="service-block-one col-lg-6">
                            <div class="inner-box p-3" style="margin-top:-20px !important">
                                ...
                                <div class="container">
                                    ...
                                    <div class="row">
                                        <div class="col-md-8 col-sm-4" style="text-align: left;">
                                        ...
                                        <div class="col-md-2 col-sm-2" style="text-align: left;display:flex">
                                            <p
            ...
            <div class="col-md-4" >
                <div class="service-block-one p-0" style="background:#282828">
                    <div class="inner-box p-3" style="margin-top:-20px !important">
                        ...
                        @if(Session::has('user_type') && Session::get('user_type')=="CLIENT")
                            <a href="{{ url('client/dashboard')}}" class="theme-btn btn-style-one mt-2">
                                <span class="btn-title">Go to Dashboard</span>
                            </a>
                        @else
                            <a href="{{ url('Auth/register')}}" class="theme-btn btn-style-one mt-2">
