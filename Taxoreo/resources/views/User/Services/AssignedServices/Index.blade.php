                    ...
                    <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
                        <ol class="breadcrumb breadcrumb-links">
                            <li class="breadcrumb-item">
                                <a href="#"><i class="fas fa-home text-primary"></i> Services</a>
                            </li>
                            <li class="breadcrumb-item"><a href="#">Assigned Services</a></li>
                        </ol>
                    </nav>
                </div>
...
@section('content')
    ...
    {{-- <div class="card mt-1">
        <div class="card-body p-1">
            <div class="row">
                <div class="col-4">
                    <label class="form-control-label">Search By Category :</label>
                    <input type="text" class="form-control form-control-sm" id="search_by_category_name" name="search_by_category_name">
                </div>
    ...
    table=$('#data-table').DataTable({
            ...
            ajax:{
                    url:"<?php echo url($url.'/show'); ?>",
                        type: 'GET',
                        data: function (d){
                            d.search_by_category_name = $('#search_by_category_name').val();
                        }
                    },
            columns:[
