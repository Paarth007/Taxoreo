                ...
                <div class="col-lg-6 col-7 text-primary text-left">
                    <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
                        <ol class="breadcrumb breadcrumb-links">
                            ...
                            <li class="breadcrumb-item"><a href="#">@if(!$id) Add @else Edit @endif SMS</a></li>
                        </ol>
                    </nav>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <input type="text" class="form-control form-control-sm"
                            id="template_name"
                            name="template_name"
                            value="{{ $sms ? $sms->template_name : NULL }}"
                            required
                            @if($sms && $sms->is_default) readonly @endif
                            >
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <label class="form-control-label">Template Id :</label>
                        <input type="text" class="form-control form-control-sm"
                            id="template_id"
                            name="template_id"
                            value="{{ $sms ? $sms->template_id : NULL }}"
                            required>
                    </div>
                </div>
            </div> <!-- CARD-->
                ...
                <div class="row">
                    <div class="col-md-12 text-left">
                        ...
                        <textarea class="form-control form-control-sm"
                            id="description"
                            name="description"
                            required>{{ $sms ? $sms->description : NULL }}</textarea>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-4 text-left d-flex justify-content-start">
                        <div class="">
                            <input type="radio"
                                ...
                                name="is_active"
                                value="1"
                                {{$sms ? ($sms->is_active==1 ? "checked" :"") : "checked" }}
                                >
                                Active
                        </div>
