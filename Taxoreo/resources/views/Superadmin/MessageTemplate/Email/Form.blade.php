                ...
                <div class="col-lg-6 col-7 text-primary text-left">
                    <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
                        <ol class="breadcrumb breadcrumb-links">
                            ...
                            <li class="breadcrumb-item"><a href="#">@if(!$id) Add @else Edit @endif Email</a></li>
                        </ol>
                    </nav>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <input type="text" class="form-control form-control-sm"
                            id="template_name"
                            name="template_name"
                            value="{{ $email ? $email->template_name : NULL }}"
                            required
                            @if($email && $email->is_default) readonly @endif
                            >
                    </div>
                </div>
            </div> <!-- CARD-->
                    ...
                    <div class="col-md-4 text-left d-flex justify-content-start">
                        <div class="">
                            <input type="radio"
                                ...
                                name="is_active"
                                value="1"
                                {{$email ? ($email->is_active==1 ? "checked" :"") : "checked" }}
                                >
                                Active
                        </div>
                        <div class="form-group ml-3">
                            <input type="radio"
                                ...
                                name="is_active"
                                value="0"
                                {{$email && $email->is_active==0 ? "checked" :"" }}
                                >
                                Deactive
                        </div>
                    </div>
