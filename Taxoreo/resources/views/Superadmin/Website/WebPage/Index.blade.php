...
<div class="card mt-1">
    <div class="card-body p-1">
        <div class="row">
            <div class="col-4">
                <label class="form-control-label">Search By Service Menu :</label>
                <input type="text" class="form-control form-control-sm" id="search_by_menu_service_name" name="search_by_menu_service_name">
            </div>
    ...
    table=$('#data-table').DataTable({
            ...
            ajax:{
                    url:"<?php echo url($url.'/show'); ?>",
                        type: 'GET',
                        data: function (d){
                            d.search_by_menu_service_name = $('#search_by_menu_service_name').val();
                        }
                    },
            columns:[
                    ...
                    {data: 'menu_service_name',orderable: true, searchable: true},
                    {data: 'menu_name',orderable: true, searchable: true},
                    {data: 'service_name',orderable: true, searchable: true},
