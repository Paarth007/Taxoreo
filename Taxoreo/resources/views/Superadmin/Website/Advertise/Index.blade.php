...
@section('content')
    ...
    <div class="card mt-0 mt--2">
        <div class="card-body pt-0 m-0">
            <p class="form-control-label">Select Column To Hide/Unhide:
                ...
                <span class="badge badge-primary toggle-vis" data-column="3">Shown In</span>
                <span class="badge badge-primary toggle-vis" data-column="4">Blog Name</span>
                <span class="badge badge-primary toggle-vis" data-column="5">Publishing Data</span>
                ...
                <table id="data-table" class="table table-hover table-flush mt-2" style="width:100%">
                    <thead class="thead-light">
                        <tr class="">
                            ...
                            <th class="p-1 text-center">Url</th>
...
@push('scripts')
<script>
    var excludedColumns=[0,1,2,3,8,9];
    var table=null;
    ...
    table=$('#data-table').DataTable({
            ...
            columns:[
                    ...
                    {data: 'advertise_title',orderable: true, searchable: true},
                    {data: 'start_date',orderable: true, searchable: true},
                    {data: 'end_date',orderable: true, searchable: true},
                    {data: 'ahref_url',orderable: true, searchable: true},
