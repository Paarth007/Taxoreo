                    ...
                    <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
                        <ol class="breadcrumb breadcrumb-links">
                            <li class="breadcrumb-item">
                                <a href="#"><i class="fas fa-home text-primary"></i> Service List</a>
                            </li>
...
<script>
    ...
    table=$('#data-table').DataTable({
            ...
            columns:[
                    ...
                    {data: 'assign_to_user_name',orderable: true, searchable: true},
    ...
    function change_user(id) {
        let user_id=$('#assigned_to_user_id_'+id).val();
        let prev_user_id=$('#previous_assigned_user_id_'+id).val();
        ...
        if(user_id!=prev_user_id){
            $.ajax({
                    ...
                    type: "POST",
                    url: "{{ url('superadmin/client-service/change-user') }}",
                    data: {'service_id':id,'user_id':user_id},
            ...
            alert("Cannot assign same user again !!!");
        }
    }
</script>
@endpush
