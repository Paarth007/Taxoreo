                ...
                <div class="col-lg-6 col-7 text-primary text-left">
                    <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
                        <ol class="breadcrumb breadcrumb-links">
                            ...
                            <li class="breadcrumb-item"><a href="#">Added Services</a></li>
                        </ol>
                    </nav>
                </div>
...
<script>
    ...
    table=$('#data-table').DataTable({
            ...
            columns:[
                    ...
                    {data: 'total_documents',orderable: true, searchable: true},
                    {data: 'uploaded_documents',orderable: true, searchable: true},
