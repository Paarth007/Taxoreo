<nav class="navbar navbar-top navbar-expand navbar-dark bg-primary border-bottom p-1">
    <div class="container-fluid">
        <div class="collapse navbar-collapse " id="navbarSupportedContent">
            <h5 class="text-white textarea-center text-left">
                  Financial Year :
                  <span data-toggle="modal" data-target="#financial_year_modal" style="cursor:pointer">
                   <?php
                      //echo date('d-M-Y',strtotime(Session::get('financial_year')[0])). " - ". date('d-M-Y',strtotime(Session::get('financial_year')[1]));
             ?>
             </span>
            </h5>
        ...
        <ul class="navbar-nav align-items-right ml-auto ml-md-0">
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-divider"></div>
                <form  id="logout_form" method="POST" action="{{ url('superadmin/login/'.Session::get('user_id')) }}">
                    @csrf
