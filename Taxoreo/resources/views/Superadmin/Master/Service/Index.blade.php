...
@section('content')
    ...
    <div class="card mt-1">
        <div class="card-body p-1">
            <div class="row">
                <div class="col-4">
                    <label class="form-control-label">Search By Service :</label>
                    <input type="text" class="form-control form-control-sm" id="search_by_service_name" name="search_by_service_name">
                </div>
    ...
    table=$('#data-table').DataTable({
            ...
            ajax:{
                    url:"<?php echo url($url.'/show'); ?>",
                        type: 'GET',
                        data: function (d){
                            d.service_name = $('#search_by_service_name').val();
                        }
                    },
            columns:[
                    ...
                    {data: 'actual_amount',orderable: true, searchable: true},
                    {data: 'display_amount',orderable: true, searchable: true},
