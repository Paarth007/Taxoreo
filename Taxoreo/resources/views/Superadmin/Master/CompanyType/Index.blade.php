                ...
                <div class="col-lg-6 col-7 text-primary text-left">
                    <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
                        <ol class="breadcrumb breadcrumb-links">
                            ...
                            <li class="breadcrumb-item"><a href="#">Company Type</a></li>
                        </ol>
                    </nav>
                </div>
...
@section('content')
    ...
    <div class="card mt-1">
        <div class="card-body p-1">
            <div class="row">
                <div class="col-4">
                    <label class="form-control-label">Search By Company Type :</label>
                    <input type="text" class="form-control form-control-sm" id="search_by_company_type" name="search_by_company_type">
                </div>
    ...
    table=$('#data-table').DataTable({
            ...
            ajax:{
                    url:"<?php echo url($url.'/show'); ?>",
                        type: 'GET',
                        data: function (d){
                            d.search_by_company_type = $('#search_by_company_type').val();
                        }
                    },
            columns:[
                    ...
                    {data: 'company_type_name',orderable: true, searchable: true},
