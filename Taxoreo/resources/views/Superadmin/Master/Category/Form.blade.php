                ...
                <div class="col-lg-6 col-7 text-primary text-left">
                    <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
                        <ol class="breadcrumb breadcrumb-links">
                            ...
                            <li class="breadcrumb-item"><a href="#">@if(!$id) Add @else Edit @endif Category</a></li>
                        </ol>
                    </nav>
                </div>
            ...
            <div class="col-md-6 text-left">
                <div class="form-group">
                    <input type="text" class="form-control form-control-sm"
                        id="category_name"
                        name="category_name"
                        value="{{  $category ? $category->category_name: NULL }}"
                        required>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-3 text-left d-flex justify-content-start">
                <div class="">
                    <input type="radio"
                        ...
                        name="is_active"
                        value="1"
                        {{$category ? ($category->is_active==1 ? "checked" :"") : "checked" }}
                        >
                        Active
                </div>
                <div class="form-group ml-3">
                    <input type="radio"
                        ...
                        name="is_active"
                        value="0"
                        {{$category && $category->is_active==0 ? "checked" :"" }}
                        >
                        Deactive
                </div>
            </div>
            ...
            <div class="col-md-6 text-left">
                <div class="form-group">
                    <input type="text" class="form-control form-control-sm input_text alpha"
                        id="remark"
                        name="remark"
                        value="{{  $category ? $category->remark:"" }}"
                        >
                </div>
            </div>
        </div>
