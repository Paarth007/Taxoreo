        ...
        <div class="card-body pt-0 m-0">
            <div class="table-responsive py-1">
                <p class="form-control-label">Select Column To Hide:
                                        ...
                                        <span class="badge badge-primary toggle-vis" data-column="3">Template Id</span>
                ...
                <table id="data-table" class="table table-hover table-flush mt-2" style="width:100%">
                    <thead class="thead-light">
                        <tr class="">
                            ...
                            <th class="p-1 text-center">Template Id</th>
...
<script>
    ...
    table=$('#data-table').DataTable({
            ...
            columns:[
                    ...
                    {data: 'template_id',orderable: true, searchable: true},
