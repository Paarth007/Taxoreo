          ...
          <ul class="navbar-nav">
                ...
                <div class="collapse" id="document-examples">
                  <ul class="nav nav-sm flex-column">
                      ...
                      <li class="nav-item mt--2">
                       ...
                       <li class="nav-item mt--2">
                        <a href="{{ url('superadmin/master/company-type') }}" class="nav-link"><i class="fa fa-dot-circle" aria-hidden="true"></i>Service Category</a>
                      </li>
                      <li class="nav-item mt--2">
            ...
            <li class="nav-item" style="border-top:1px solid #EAEDED">
                ...
                <div class="collapse" id="navbar-client-services">
                  <ul class="nav nav-sm flex-column">
                    <li class="nav-item mt--2">
                      <a href="{{ url('superadmin/service-list/client-added-services') }}" class="nav-link"><i class="fa fa-dot-circle" aria-hidden="true"></i> Client Added</a>
                    </li>
                    <li class="nav-item mt--2">
                        <a href="{{ url('superadmin/user-list/ca') }}" class="nav-link"><i class="fa fa-dot-circle" aria-hidden="true"></i>CA's</a>
                    </li>
