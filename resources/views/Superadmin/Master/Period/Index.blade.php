...
@section('content')
    ...
    <div class="card mt-1">
        <div class="card-body p-1">
            <div class="row">
                <div class="col-9">
                    <label class="form-control-label">Search Period :</label>
                    <input type="text" class="form-control form-control-sm" id="search_by_period_name" name="search_by_period_name">
                </div>
        ...
        <div class="card-body pt-0 m-0">
            <div class="table-responsive py-1">
                <p class="form-control-label">Select Column To Hide:
                                        ...
                                        <span class="badge badge-primary toggle-vis" data-column="3">Period Name</span>
                                        <span class="badge badge-primary toggle-vis" data-column="4">From Date</span>
                                        <span class="badge badge-primary toggle-vis" data-column="5">To Date</span>
                ...
                <table id="data-table" class="table table-hover table-flush mt-2" style="width:100%">
                    <thead class="thead-light">
                        <tr class="">
                            ...
                            <th class="p-1 text-center">Period Name</th>
                    ...
                    <tfoot class="p-0">
                        <tr class="p-0">
                            ...
                            <th class="p-1"></th>
                            <th class="p-1"></th>
                            <th class="p-1">Period Name</th>
                            <th class="p-1">From Date</th>
                            <th class="p-1">To Date</th>
                            <th class="p-1"></th>
                            <th class="p-1"></th>
                        </tr>
                    </tfoot>
    ...
    table=$('#data-table').DataTable({
            ...
            ajax:{
                    url:"<?php echo url($url.'/show'); ?>",
                        type: 'GET',
                        data: function (d) {
                            d.period_name = $('#search_by_period_name').val();
                        }
                    },
            columns:[
                    ...
                    {data: 'period_name',orderable: true, searchable: true},
