                ...
                <div class="col-lg-6 col-7 text-primary text-left">
                    <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
                        <ol class="breadcrumb breadcrumb-links">
                            ...
                            <li class="breadcrumb-item"><a href="#">@if(!$id) Add @else Edit @endif Period</a></li>
                        </ol>
                    </nav>
                </div>
    ...
    <div class="card card-body">
        <div class="row m-0">
            <div class="col-md-3 text-right">
                <label class="form-control-label">Period Name :</label>
            </div>
            <div class="col-md-6 text-left">
                <div class="form-group">
                    <input type="text" class="form-control form-control-sm"
                        id="period_name"
                        name="period_name"
                        value="{{  $period ? $period->period_name: NULL }}"
                        required>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-6 text-left">
                <div class="form-group">
                    <input type="date" class="form-control form-control-sm"
                        id="from_date"
                        name="from_date"
                        value="{{  $period ? $period->from_date: NULL }}"
                        required>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-6 text-left">
                <div class="form-group">
                    <input type="date" class="form-control form-control-sm"
                        id="to_date"
                        name="to_date"
                        value="{{  $period ? $period->to_date: NULL }}"
                        required>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-3 text-left d-flex justify-content-start">
                <div class="">
                    <input type="radio"
                        ...
                        name="is_active"
                        value="1"
                        {{$period ? ($period->is_active==1 ? "checked" :"") : "checked" }}
                        >
                        Active
                </div>
                <div class="form-group ml-3">
                    <input type="radio"
                        ...
                        name="is_active"
                        value="0"
                        {{$period && $period->is_active==0 ? "checked" :"" }}
                        >
                        Deactive
                </div>
            </div>
