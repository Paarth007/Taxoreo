                ...
                <div class="col-lg-6 col-7 text-primary text-left">
                    <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
                        <ol class="breadcrumb breadcrumb-links">
                            ...
                            <li class="breadcrumb-item"><a href="#">@if(!$id) Add @else Edit @endif Menu Service</a></li>
                        </ol>
                    </nav>
                </div>
    ...
    <div class="card card-body">
        <div class="row m-0">
            <div class="col-md-3 text-right">
                <label class="form-control-label">Menu Service Name :</label>
            </div>
            <div class="col-md-6 text-left">
                <div class="form-group">
                    <input type="text" class="form-control form-control-sm"
                        id="menu_service_name"
                        name="menu_service_name"
                        value="{{  $menu_service ? $menu_service->menu_service_name: NULL }}"
                        required>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-6 text-left">
                <div class="form-group">
                    <input type="text" class="form-control form-control-sm"
                        ...
                        value="{{  $menu_service ? $menu_service->redirection_url: '#' }}"
                        required>
                </div>
            </div>
            ...
            <div class="col-md-3 text-left d-flex justify-content-start">
                <div class="">
                    <input type="radio"
                        ...
                        name="is_active"
                        value="1"
                        {{$menu_service ? ($menu_service->is_active==1 ? "checked" :"") : "checked" }}
                        >
                        Active
                </div>
                <div class="form-group ml-3">
                    <input type="radio"
                        ...
                        name="is_active"
                        value="0"
                        {{$menu_service && $menu_service->is_active==0 ? "checked" :"" }}
                        >
                        Deactive
                </div>
            </div>
            ...
            <div class="col-md-6 text-left">
                <div class="form-group">
                    <input type="text" class="form-control form-control-sm input_text alpha"
                        id="remark"
                        name="remark"
                        value="{{  $menu_service ? $menu_service->remark:"" }}"
                        >
                </div>
            </div>
        </div>
